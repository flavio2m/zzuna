...
import 'package:zzuna/ui/lista_compras/update/comprar/widgets/item_compra_marcar_comprado_menu_item.dart';
...
class ItemCompraCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
              ...
              Row(
                children: [
                  ...
                  PopupMenuButton<void>(
                    ...
                    onSelected: (_) {},
                    itemBuilder: (ctx) => [
                      if (item.situacao != ItemCompraSituacao.cancelado)
    ...
    return Dismissible(
      key: ValueKey('item_compra_${item.id}'),
      direction: isRunning
      ...
      background: _buildSwipeBackground(
        ...
        color: item.situacao == ItemCompraSituacao.cancelado
            ? AppColors.slate600
            : AppColors.rose600,
        icon: item.situacao == ItemCompraSituacao.cancelado
            ? Icons.refresh
            : Icons.block,
        label: item.situacao == ItemCompraSituacao.cancelado
            ? 'Reativar'
            : 'Cancelar',
      ),
      secondaryBackground: _buildSwipeBackground(
        ...
        icon: item.situacao == ItemCompraSituacao.comprado
            ? Icons.remove_shopping_cart
            : Icons.check_circle,
        label: item.situacao == ItemCompraSituacao.comprado
            ? 'Desmarcar'
            : 'Comprar',
      ),
